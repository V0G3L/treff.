...
%%%%%%%% Server %%%%%%%%%%
  ...
  \begin{frame}[plain]
      ...
      \begin{minipage}{0.5\textwidth}
          ...
          \begin{figure}
              \includegraphics
              [clip, trim=10pt 155pt 140pt 05pt,width=0.95\textwidth]
  ...
  \begin{frame}[plain]
        ...
        \only<1>{
            \begin{figure}
                ...
                \chronoevent{15}{\code{x.isInGroup(g)}}
                \chronoevent{31}{\code{x.chat(g, foo)}}
            ...
            \begin{figure}
                ...
                \chronoevent[markdepth=30pt]{39}{\code{x.leaveGroup(g)}}
...
\begin{frame}[plain]
      \frametitle{\textbf{Client} -- Grobe Architektur: MVVM}
        \begin{figure}
      		\includegraphics[height = \paperheight - 50pt]{images/mvvm.png}
		\caption{Beispiel aus Klassendiagramm}
    	\end{figure}
  \end{frame}
