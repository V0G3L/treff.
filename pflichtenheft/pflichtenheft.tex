...
\functionality{Gründen von Gruppen}{groupfounding}{30}
\fulfills{groups}
Nutzer können Gruppen erstellen und diese verwalten, indem sie andere Nutzer
hinzufügen oder entfernen.

\functionality{Umgebungskarte}{map}{60}
\fulfills{location}
...
\functionality{Verwaltung von Kontodaten}{options}{20}
\fulfills{account}
...
\functionalityOpt{Passwortzurücksetzung}{passwordReset}{60}
