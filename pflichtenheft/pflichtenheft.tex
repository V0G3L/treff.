...
\functionality{Verwaltung von Einstellungen und Account- oder appbezogenen Daten}{fnc:options}{20}
\fulfills{crt:account}
...
\functionality{Standortteilung für zwei einzelne Personen}{fnc:1to1}{30}
\fulfills{crt:1to1}
\fulfills{crt:location}
...
als auch die Standortanfragen (\functionalitylink{fnc:locationrequest}) lassen
