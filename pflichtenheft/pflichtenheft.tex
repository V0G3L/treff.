...
\test{Positionsanfrage}{posshare}{60}
\tests{request}
\testStep{In der Gruppe \enquote{Lerngruppe} befinden sich die vier Freunde Alice, Bob, Frank und Ted.}
...
\testStep{Alle haben die Benachrichtigung erhalten.}
