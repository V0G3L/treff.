...
\begin{minipage}{0.5\textwidth}
	\setlength{\fboxsep}{0pt}% space between border and image
	\setlength{\fboxrule}{1pt}% width of border
	\fbox{\includegraphics[width = 45mm]{images/gui-mockups/group_members.png}}
	\captionsetup{labelformat=empty}
	\centering
	\captionof{figure}{Gruppe}
\end{minipage}%
\begin{minipage}{0.5\textwidth}
	\begin{itemize}
		\setlength\itemsep{0.3em}
...
\begin{minipage}{0.5\textwidth}
	\setlength{\fboxsep}{0pt}% space between border and image
	\setlength{\fboxrule}{1pt}% width of border
	\fbox{\includegraphics[width = 45mm]{images/gui-mockups/paper_prototype.png}}
	\captionsetup{labelformat=empty}
	\centering
	\captionof{figure}{Prototypen auf Papier}
\end{minipage}%
\begin{minipage}{0.5\textwidth}
	\textbf{Kommunikation}
	\begin{itemize}
