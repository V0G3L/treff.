...
\subsection{Account - account}
%TODO account-ERD einfügen
Ein Nutzer wird im System in Form eines Accounts repräsentiert.
Dieser wird durch eine eindeutige Identifikationsnummer 'id' identifiziert und angesprochen.
Jeder Account beinhaltet den Nutzernamen 'username' und die verwendete E-Mailadresse 'email' des zugehörigen Nutzers.
Für den Account wird desweiteren der Hash seines Passworts und des Salts, sowie das verwendete Salt gespeichert.
...
Ein Account beinhaltet eine beliebig große Menge von Accounts, den Kontakten/Freunden des Nutzers.
Diese Menge darf leer sein, jedoch nicht den eigenen Account beinhalten.
Ein Account beinhaltet eine weitere, beliebig große Menge von Accounts.
Diese Menge stellt die vom Nutzer blockierten Accounts dar und darf leer sein,
jedoch nicht den eigenen Account beinhalten. Ein Account kann Verabredungen erstellen und an solchen teilnehmen.
Ein Account kann Abstimmungen innerhalb einer Gruppe erstellen und für deren Optionen abstimmen.
Jeder Account besitzt eine Gruppenmitgliedschaft für jede Gruppe, in der er mitglied ist.
%TODO Warum haben wir was wie gemacht

\subsection{Gruppenmitgliedschaft - groupmembership}
%TODO groupmembership-ERD einfügen
Eine Gruppenmitgliedschaft gehört zu exakt einem Account und zu exakt einer Gruppe.
...
welche Rechte der zugehörige Account in der zugehörigen Gruppe hat.
...
\begin{itemize}
	\item 'permission-change-group-name' - das Recht, den Namen der Gruppe zu ändern.
 	\item 'permission-manage-members' - das Recht, Nutzer bzw deren Accounts in die Gruppe hinzuzufügen bzw Gruppenmitglieder zu entfernen.
...
\end{itemize}
%TODO Warum haben wir was wie gemacht
Diese Abbildung der Gruppenmitgliedschaften wurde gewählt um eine Dreiecksbeziehung zwischen Account,
Gruppe und den Berechtigungen aufzulösen.

\subsection{Gruppe - group}
...
\subsection{Abstimmung - poll}
%TODO poll-ERD einfügen
Eine Abstimmung wird durch eine eindeutige Identifikationsnummer 'id' identifiziert und angesprochen.
Eine Abstimmung besteht aus einer Frage, die für diese Abstimmung gestellt wird und einem Wahrheitswert der festlegt,
ob die Abstimmung dem Nutzer erlaubt für mehrere oder nur für eine Option zu stimmen.
Außerdem beinhaltet sie eine beliebig große Menge von Optionen der Abstimmung, aber mindestens eine.
Desweiteren speichert die Abstimmung einen Account, ihren Ersteller.
%ODO Warum haben wir was wie gemacht

\subsection{Option einer Abstimmung - polloption}
...
Weiterhin wird eine beliebige Menge von Accounts gespeichert die für diese Option gestimmt haben.
%TODO Warum haben wir was wie gemacht

\subsection{Verabredung - event}
...
\subsubsection{MVVM}
Um diese Entkopplung zu erreichen kommt die MVVM-Architektur (Model-View-ViewModel) zu Einsatz.
...
\begin{center}
	...
	\captionof{figure}{Bei dieser Darstellung sind View und ViewModel nicht als tatsächliche packages
		zu verstehen, sondern dienen lediglich der vereinfachten Darstellung. Ebenso wenig ist dieses Diagramm vollständig. Fehlende Klassen verhalten sich allerdings äquivalent.}
	
\end{center}

\subsubsection{LiveData}
Um sicherzustellen, dass die View stets mit dem Model synchronisiert ist, bietet Android eine
WrapperKlasse anems LiveData an, welche von View-Elementen \enquote{observed} werden kann.
...
\begin{center}
	...
	\captionof{figure}{Dieser Ablauf steht beispielhaft für fast alle Zugriffe auf die Datenbank.
...
%
>>>>>>> Working on client section, added images and puml source fo them
...
Settings-Activity dar, in welcher der Nutzer Accounteinstellungen vornehmen kann.
...
kaum untereinander, da alle anderen lediglich eine Liste darstellen müssen. Um dies zu bewerkstelligen
...
\begin{center}
	\includegraphics[width = \columnwidth / 3 * 2]{lists2.png}
\end{center}
