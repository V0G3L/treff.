...
\begin{itemize}
	\item 'permission-change-group-name' - das Recht, den Namen der Gruppe zu
        ändern.
 	\item 'permission-manage-members' - das Recht, Nutzer bzw dessen
        Benutzerkonto in die Gruppe hinzuzufügen und Gruppenmitglieder zu 
        entfernen.
 	\item 'permission-change-permissions' - das Recht, die
        Gruppenberechtigungen der Gruppenmitglieder zu bearbeiten.
 	\item 'permission-create-event' - das Recht, Verabredungen zu erstellen.
 	\item 'permission-edit-any-event' - das Recht, Verabredungen zu bearbeiten,
        welche man nicht selbst erstellt hat.
 	\item 'permission-create-poll' - das Recht, Abstimmungen zu erstellen.
 	\item 'permission-edit-any-poll' - das Recht, Abstimmungen zu bearbeiten,
        welche man nicht selbst erstellt hat.
\end{itemize}
