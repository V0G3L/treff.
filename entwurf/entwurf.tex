...
Benutzerkonto gehört (siehe \ref{sec:accountdesc})}
{400/Nutzername ungültig}
...
{500/Verabredungs-Identifikationsnummer ungültig oder Benutzerkonto nicht Teil
der Gruppe,
300/Gruppen-Identifikationsnummer ungültig oder Benutzerkonto nicht Teil der
Gruppe}
...
710/Kein Benutzerkonto eingeladen{,} das nicht das eigene ist}
...
820/Das Benutzerkonto besitzt nicht die nötigen Rechte{,} um in der angegebenen
Gruppe Verabredungen erstellen zu können}
...
{300/Gruppen-Identifikationsnummer ungültig oder Benutzerkonto nicht Teil der
Gruppe,
900/Endzeitpunkt von einer der Optionen liegt in der Vergangenheit,
910/Endzeitpunkt von einer der Optionen liegt nicht nach dem dazugehörigen
Startzeitpunkt,
920/Das Benutzerkonto besitzt nicht die nötigen Rechte{,} um in der angegebenen
Gruppe Abstimmungen erstellen zu können}
...
{---/Leeres JSON-Objekt bei Erfolg}
{2100/Benutzerkonto-Identifikationsnummer ungültig oder eigenes Benutzerkonto
wird vom angegeben blockiert,
...
{id/Identifikationsnummer des anderen Benutzerkontos}
{---/Leeres JSON-Objekt bei Erfolg}
{2200/Benutzerkonto-Identifikationsnummer ungültig,
...
{Hebt die Blockierung des angegebenen Benutzerkontos durch das eigene auf.}
{id/Identifikationsnummer des anderen Benutzerkontos}
{---/Leeres JSON-Objekt bei Erfolg}
{2200/Benutzerkonto-Identifikationsnummer ungültig}
