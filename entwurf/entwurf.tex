...
\begin{figure}
    \centering
    \includegraphics[width = \columnwidth / 3 * 2]{lists.png}
...
wieder in sinnvolle Java-Objekte um. Der ConnectionHandler ist nun lediglich 
...
angeforderten Daten als LiveData aus der Datenbank angefordert und an das 
