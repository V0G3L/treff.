...
\apiErrorNew{no-permission-group-edit}{140}{Das Benutzerkonto besitzt nicht
die nötigen Rechte, um die Gruppe zu editieren}
\apiErrorNew{user-already-in-group}{150}{Mindestens eine Identifikationsnummer
gehört zu einem Benutzerkonto, welches bereits Teil der Gruppe ist}
\apiErrorNew{user-not-in-group}{160}{Mindestens eine Identifikationsnummer
gehört zu einem Benutzerkonto, welches nicht Teil der Gruppe ist}
\apiErrorNew{no-permission-members-edit}{170}{Das Benutzerkonto besitzt nicht
die nötigen Rechte, um die Liste an Gruppenmitgliedern zu editieren}
\apiErrorNew{no-permission-event-edit}{180}{Das Benutzerkonto besitzt nicht
die nötigen Rechte, um die Verabredung editieren zu können}
\apiErrorNew{no-permission-poll-edit}{190}{Das Benutzerkonto besitzt nicht die
nötigen Rechte, um die Abstimmung zu editieren}
% TODO: editieren vs. editieren zu können
\apiErrorNew{being-blocked}{200}{Das eigenes Benutzerkonto wird vom angegeben
Benutzerkonto blockiert}
\apiErrorNew{not-in-contacts}{210}{Das angegebene Benutzerkonto ist nicht in
der eigenen Kontaktliste}
\apiErrorNew{blocking-already}{220}{Das eigene Benutzerkonto blockiert das
angegebene Benutzerkonto}
\apiErrorNew{not-blocking}{230}{Angegebenes Benutzerkonto wird nicht durch das
eigene Benutzerkonto blockiert}
\apiErrorNew{user-id-invalid}{240}{Benutzerkonto-Identifikationsnummer
ungültig}
\apiErrorNew{time-measured-future}{250}{Messzeitpunkt liegt zu weit in der
Zukunft}
