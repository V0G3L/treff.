...
handelt es sich dabei um das GroupEventFragment und GroupChatFragment. In
...
betreffen. Darin unterscheiden sich die Settings von den meisten anderen
Activities. Einstellungen wie dem Stummschalten, welche nur den Nutzer selbst
betreffen und für den Server nicht relevant sind, werden hingegen in den
SharedPreferences abgelegt.
...
Die Implementierung des Interfaces AccountManager sind für den
